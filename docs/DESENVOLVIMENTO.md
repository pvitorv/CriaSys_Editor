...
Para retomar contexto das branches recentes, leia na raiz: `HANDOFF_015.md` (015), `HANDOFF_013.md` (013), `HANDOFF_012.md` (012), `HANDOFF_010.md` (010), `HANDOFF_008-fix-editor.md` (008/009).
